...
class AufgabeDirective(ElementDirective):
    """A custom aufgabe directive."""

    name = "aufgabe"

class QuizDirective(ElementDirective):
    """A custom quiz directive."""
...
class BeispielDirective(ElementDirective):
    """A custom beispiel directive."""

    name = "beispiel"

class AnnahmeDirective(ElementDirective):
    """A custom annahme directive."""
